	...
	<div>
		<a-dropdown :trigger="['click']">
		 ...
		 <a-dropdown :trigger="['click']" v-model="visible">
			 <a-menu slot="overlay">
				<a-menu-item key="1">
					<a-select mode="tags" :defaultValue="defaultValue" style="width: 210px" @change="handleChange" placeholder="Tags Mode">
...
export default {
	data() {
		return {
			value: this.$store.state.base_currency,
			visible: false,
			defaultValue: this.$store.state.selected_currency
		}
	},
	methods: {
      onChange(e) {
